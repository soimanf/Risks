...
much challenged and far from mainstream adoption. Thus, we
...
between Blockchain attacks and cryptocurrency volatility, 
illustrating the relationship between technological vulnerabilities
and financial risk. While we consider the existent
literature on the vulnerabilities and risks associated with the
crypto-market, we cannot ignore the little work concerning
...
threefold. First, we perform a literature survey comprising the crypto-market’s risks. Secondly, we show a link between technological risks and financial ones. Thirdly, we provide empirical results showing that bitcoin’s price stability is disturbed by technological vulnerabilities.
\\
...
Technological vulnerabilities could perhaps be perceived as less harmful if investors are better protected. At the same time, we can easily see that the development of the crypto-market depends not only on technological innovation but also on the legal system that supports it. 
