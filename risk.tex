...
Regardless the big potential and great innovative solutions brought by
...
grouped by the types of risk. In our search we have used a big variety
...
as the cryptos' prices have a big influence \citep{Crypto51.app2020}.
...
with misleading information or big amounts of data
...
common and harmful incidents \footnote{In 2018 Coincheck’s wallets
  ...
  biggest theft in the crypto history \citep{Shane2018}.}. This
...
\footnote{Specific risk concerns isolated cases (one crypto-asset or a
  ...
  casualties than a systematic risk, which affects a big part of the
  market or the whole.}.
 ...
 Permissionless Blockchains- the most common and big representatives
...
markets. Taking into account the big number of crypto scams and the
...
A liquid market will be stable, showing less volatility and a bigger
...
hoarding implies a significant movement in prices (buy/sell big
...
time, we would like to mention that there are big chances that the
...
a big implication in how crypto-market players behave.
...
\citep{BotoS2017}. Knowing that a big part of the vulnerabilities
