...
{\multirow{7}{*}{\rotatebox[origin=r]{90}{\cellcolor[HTML]{FFFFFF}\textbf{Consensus level attack}}}} &
 ...
 {\cellcolor[HTML]{EFEFEF}\textit{· Manipulates the system by entering
  ...
  {{\cellcolor[HTML]{EFEFEF}\textit{Blockchains using PoS (over 400 cryptocurrencies\footnote{The total number of cryptocurrencies is over 2500 \citep{CryptoSlate.com2020}}) source:\citep{CryptoSlate.com2020}}}}
 \\
&
 ...
 &
  ...
  {\cellcolor[HTML]{FFFFFF}\textit{Blockchains using PoS (over 400 cryptocurrencies) source:\citep{CryptoSlate.com2020}}} \\
 &
  {\cellcolor[HTML]{FFFFFF}} &
...
&
  ...
  {\cellcolor[HTML]{EFEFEF}\textit{·            Manipulates the system by entering invalid or big   flow of data}} &
